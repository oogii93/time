...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.arrival-records.update", [$arrivalRecord->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('recorded_at') ? 'is-invalid' : '' }}" type="text" name="recorded_at" id="recorded_at" value="{{ old('recorded_at', $arrivalRecord->recorded_at) }}" required>

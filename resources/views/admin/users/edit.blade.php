        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.users.update', [$user->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required" for="staff_number"></label>
                    <input class="form-control {{ $errors->has('staff_number') ? 'is-invalid' : '' }}" type="text"
                        name="staff_number" id="staff_number" value="{{ old('staff_number', $user->staff_number) }}"
                        required>
                    @if ($errors->has('staff_number'))
                        <span class="text-danger">{{ $errors->first('staff_number') }}</span>
                    @endif

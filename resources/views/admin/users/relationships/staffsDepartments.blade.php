    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-staffsDepartments">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($departments as $key => $department)
                            <tr data-entry-id="{{ $department->id }}">
                                ...
                                <td>
                                    @foreach($department->staffs as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-staffsDepartments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
